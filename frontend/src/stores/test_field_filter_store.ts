...
console.log(
  "✓ Added second filter:",
  useFieldFilterStore.getState().activeFilters
);
...
const allUniqueIds = filters.every(
  (f, i, arr) => arr.findIndex((other) => other.id === f.id) === i
);
