 ...
 */
import type { AvailableFieldResponseSchemaName } from './availableFieldResponseSchemaName';
import type { AvailableFieldResponseConfig } from './availableFieldResponseConfig';
 ...
 */
export interface AvailableFieldResponse {
  field_id: string;
  field_name: string;
  field_type: string;
  schema_name: AvailableFieldResponseSchemaName;
  display_order: number;
  show_on_card: boolean;
  config?: AvailableFieldResponseConfig;
}
