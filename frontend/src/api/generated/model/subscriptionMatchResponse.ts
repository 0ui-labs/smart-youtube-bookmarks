 ...
 */
import type { SubscriptionMatchResponseSource } from './subscriptionMatchResponseSource';

/**
 * Schema for subscription match in API responses.
 */
export interface SubscriptionMatchResponse {
  id: string;
  subscription_id: string;
  video_id: string;
  matched_at: string;
  source: SubscriptionMatchResponseSource;
}
