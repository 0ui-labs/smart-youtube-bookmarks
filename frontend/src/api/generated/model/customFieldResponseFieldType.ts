 ...
 */
export type CustomFieldResponseFieldType = typeof CustomFieldResponseFieldType[keyof typeof CustomFieldResponseFieldType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CustomFieldResponseFieldType = {
  select: 'select',
  rating: 'rating',
  text: 'text',
  boolean: 'boolean',
