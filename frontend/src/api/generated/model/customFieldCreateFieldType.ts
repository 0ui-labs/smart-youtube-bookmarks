 ...
 */
export type CustomFieldCreateFieldType = typeof CustomFieldCreateFieldType[keyof typeof CustomFieldCreateFieldType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CustomFieldCreateFieldType = {
  select: 'select',
  rating: 'rating',
  text: 'text',
  boolean: 'boolean',
