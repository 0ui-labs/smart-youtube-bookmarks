 ...
 */
import type { SchemaFieldUpdateDisplayOrder } from './schemaFieldUpdateDisplayOrder';
import type { SchemaFieldUpdateShowOnCard } from './schemaFieldUpdateShowOnCard';

/**
 * Request body for updating schema field association.
 */
export interface SchemaFieldUpdate {
  display_order?: SchemaFieldUpdateDisplayOrder;
  show_on_card?: SchemaFieldUpdateShowOnCard;
}
