 ...
 */
import type { ChatResponseSchemaSubscriptionPreview } from './chatResponseSchemaSubscriptionPreview';
...
export interface ChatResponseSchema {
  ...
  subscription_preview: ChatResponseSchemaSubscriptionPreview;
  /** Whether subscription has enough info to be created */
  ready_to_create: boolean;
  /** Full conversation history including new messages */
