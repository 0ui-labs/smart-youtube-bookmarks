 ...
 */
import type { JobProgressEventReadProgressData } from './jobProgressEventReadProgressData';

/**
 * Schema for reading a progress event
 */
export interface JobProgressEventRead {
  id: string;
  job_id: string;
  created_at: string;
  progress_data: JobProgressEventReadProgressData;
}
