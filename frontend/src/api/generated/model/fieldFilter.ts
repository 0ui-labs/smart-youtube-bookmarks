 ...
 */
import type { FieldFilterOperator } from './fieldFilterOperator';
import type { FieldFilterValue } from './fieldFilterValue';
import type { FieldFilterValueMin } from './fieldFilterValueMin';
import type { FieldFilterValueMax } from './fieldFilterValueMax';

/**
 * Single field filter specification.
 */
export interface FieldFilter {
  /** UUID of custom field to filter by */
  field_id: string;
  /** Filter operator */
  operator: FieldFilterOperator;
  /** Filter value */
  value?: FieldFilterValue;
  /** Min value for BETWEEN */
  value_min?: FieldFilterValueMin;
  /** Max value for BETWEEN */
  value_max?: FieldFilterValueMax;
}
