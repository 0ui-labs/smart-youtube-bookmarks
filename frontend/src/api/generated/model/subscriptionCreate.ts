 ...
 */
import type { SubscriptionCreateChannelIds } from './subscriptionCreateChannelIds';
import type { SubscriptionCreateKeywords } from './subscriptionCreateKeywords';
import type { SubscriptionFilters } from './subscriptionFilters';
import type { SubscriptionCreatePollInterval } from './subscriptionCreatePollInterval';

/**
 * Schema for creating a new subscription.
 */
export interface SubscriptionCreate {
  /** Target list for imported videos */
  list_id: string;
  /**
   * Subscription name
   * @minLength 1
  ...
  channel_ids?: SubscriptionCreateChannelIds;
  /** Keywords to search for */
  keywords?: SubscriptionCreateKeywords;
  /** Video matching filters */
  filters?: SubscriptionFilters;
  /** How often to poll for new videos */
  poll_interval?: SubscriptionCreatePollInterval;
}
