 ...
 */
export interface SchemaFieldBatchUpdateResponse {
  /** Number of fields updated */
  updated_count: number;
  /** Complete updated schema_fields list with nested field data */
  fields: AppSchemasFieldSchemaSchemaFieldResponse[];
}
