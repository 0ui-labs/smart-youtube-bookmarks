...
export interface AIFilterSettings {
  /** Enable AI-based relevance filtering */
  enabled?: boolean;
  /** Include video transcript in analysis (more accurate but slower) */
  use_transcript?: boolean;
  /** Include top comments in analysis (helps detect clickbait) */
