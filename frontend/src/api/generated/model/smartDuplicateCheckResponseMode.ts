 ...
 * Detection mode used
 */
export type SmartDuplicateCheckResponseMode = typeof SmartDuplicateCheckResponseMode[keyof typeof SmartDuplicateCheckResponseMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SmartDuplicateCheckResponseMode = {
  basic: 'basic',
  smart: 'smart',
} as const;
