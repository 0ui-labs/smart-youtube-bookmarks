...
describe('VideoDetailsPage', () => {
  ...
  describe('Field Grouping by Schema', () => {
    ...
    it('shows field count in section header', () => {
      ...
      // 3 available fields
      expect(screen.getByText(/tutorial schema \(3 felder\)/i)).toBeInTheDocument()
    })
    ...
    it('shows singular "Feld" for single field', () => {
      ...
      expect(screen.getByText(/tutorial schema \(1 feld\)/i)).toBeInTheDocument()
    })
  ...
  describe('Accessibility', () => {
    ...
    it('field sections have proper structure', () => {
      ...
      const fieldsHeading = screen.getByRole('heading', { level: 2, name: /benutzerdefinierte felder/i })
