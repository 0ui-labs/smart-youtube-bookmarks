...
describe("extractYouTubeId", () => {
  describe("valid formats", () => {
    ...
    it("extracts ID with v parameter not first", () => {
      expect(
        extractYouTubeId(
          "https://www.youtube.com/watch?list=PLtest&v=dQw4w9WgXcQ"
        )
      ).toBe("dQw4w9WgXcQ");
    });
...
describe("parseUrlsFromText", () => {
  describe("single URL", () => {
    it("parses single YouTube URL", () => {
      expect(
        parseUrlsFromText("https://youtube.com/watch?v=abc12345678")
      ).toEqual(["https://youtube.com/watch?v=abc12345678"]);
    });
...
https://www.youtube.com/embed/dQw4w9WgXcQ`;
  ...
  describe("edge cases", () => {
    ...
    it("handles text with only non-YouTube URLs", () => {
      expect(
        parseUrlsFromText("https://google.com https://vimeo.com/123")
      ).toEqual([]);
    });
...
describe("parseWeblocFile", () => {
  const createWeblocFile = (content: string): File =>
    new File([content], "test.webloc", { type: "text/xml" });
