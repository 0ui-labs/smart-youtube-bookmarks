...
describe("SchemaCard", () => {
  ...
  it("renders schema name", () => {
    render(<SchemaCard listId="list-1" schema={mockSchema} />, {
  ...
  it("renders schema description", () => {
    ...
    expect(
      screen.getByText("Fields for rating makeup tutorials")
    ).toBeInTheDocument();
  });
  ...
  it("renders without description when not provided", () => {
    ...
    render(<SchemaCard listId="list-1" schema={schemaNoDescription} />, {
      wrapper: createWrapper(),
    });

    expect(screen.getByText("Makeup Tutorial Criteria")).toBeInTheDocument();
    expect(
      screen.queryByText("Fields for rating makeup tutorials")
  ...
  it("renders singular field count correctly", () => {
    ...
    render(<SchemaCard listId="list-1" schema={singleFieldSchema} />, {
      wrapper: createWrapper(),
    });
