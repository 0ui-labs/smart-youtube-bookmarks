...
describe('NewFieldForm', () => {
  ...
  describe('Duplicate Validation', () => {
    ...
    it('shows existing field info in warning message', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/presentation quality.*type.*rating/i)).toBeInTheDocument()
      })
    })
  })
  ...
  describe('Form Validation', () => {
    ...
    it('validates rating max_rating is between 1-10', async () => {
      ...
      const maxRatingInput = screen.getByLabelText(/max rating/i) as HTMLInputElement
