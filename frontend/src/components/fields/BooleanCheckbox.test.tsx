...
describe('BooleanCheckbox', () => {
  ...
  it('calls onChange on click', async () => {
    ...
    render(<BooleanCheckbox {...defaultProps} value={false} onChange={onChange} />)
  ...
  it('toggles between true and false', async () => {
    ...
    const { rerender } = render(
      <BooleanCheckbox {...defaultProps} value={false} onChange={onChange} />
    )
    ...
    rerender(
      <BooleanCheckbox {...defaultProps} value={true} onChange={onChange} />
    )
    expect(checkbox).toBeChecked()
  ...
  it('has accessible aria-label describing state', () => {
    const { rerender } = render(
      <BooleanCheckbox {...defaultProps} value={false} fieldName="Watched" />
    )
    ...
    rerender(<BooleanCheckbox {...defaultProps} value={true} fieldName="Watched" />)
  ...
  it('prevents event propagation on checkbox click', async () => {
    ...
    render(
      <div onClick={parentClick}>
        <BooleanCheckbox {...defaultProps} value={false} onChange={vi.fn()} />
      </div>
    )
