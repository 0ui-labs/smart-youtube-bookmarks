...
describe("TiptapEditor Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("renders with initial content", async () => {
      const { container } = render(
        <TiptapEditor {...defaultProps} content="<p>Hello World</p>" />
      );
    ...
    it("applies custom className", async () => {
      const { container } = render(
        <TiptapEditor {...defaultProps} className="custom-class" />
      );
    ...
    it("renders character count when maxLength is provided", async () => {
      render(
        <TiptapEditor {...defaultProps} content="<p>Test</p>" maxLength={100} />
      );
  ...
  describe("Props", () => {
    it("respects placeholder prop", async () => {
      const { container } = render(
        <TiptapEditor {...defaultProps} placeholder="Custom placeholder..." />
      );
