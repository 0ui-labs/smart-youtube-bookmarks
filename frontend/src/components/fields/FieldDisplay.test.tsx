...
const createSelectFieldValue = (
  value: string | null = "good"
): VideoFieldValue => ({
...
const createTextFieldValue = (
  value: string | null = "Great tutorial!"
): VideoFieldValue => ({
...
describe("FieldDisplay", () => {
  ...
  describe("Rating Field", () => {
    ...
    it("handles null value for rating field", () => {
      ...
      const ratingGroup = screen.getByRole("radiogroup", {
        name: /overall rating: 0 out of 5/i,
      });
      expect(ratingGroup).toBeInTheDocument();
    });
    ...
    it("passes className to RatingStars", () => {
      ...
      const { container } = render(
        <FieldDisplay className="custom-class" fieldValue={fieldValue} />
      );
  ...
  describe("Select Field", () => {
    ...
    it("passes className to SelectBadge", () => {
      const fieldValue = createSelectFieldValue("good");
      render(<FieldDisplay className="custom-class" fieldValue={fieldValue} />);
  ...
  describe("Text Field", () => {
    ...
    it("truncates long text at 50 characters with truncateAt prop (readonly)", () => {
      ...
      expect(
        screen.getByText(truncatedText, { exact: false })
      ).toBeInTheDocument();
    ...
    it("passes onChange callback to TextSnippet with string value", () => {
      ...
      // Simulate typing
      const _event = { target: { value: "Updated text" } };
    ...
    it("passes onExpand callback to TextSnippet (readonly)", () => {
      ...
      render(
        <FieldDisplay fieldValue={fieldValue} onExpand={onExpand} readonly />
      );
  ...
  describe("Edge Cases", () => {
    it("applies readonly prop to all field types", () => {
      ...
      const { rerender } = render(
        <FieldDisplay fieldValue={ratingField} readonly />
      );
  ...
  describe("Type Safety", () => {
    it("handles exhaustiveness check with console.error", () => {
      ...
      const { container } = render(
        <FieldDisplay fieldValue={invalidFieldValue} />
      );
