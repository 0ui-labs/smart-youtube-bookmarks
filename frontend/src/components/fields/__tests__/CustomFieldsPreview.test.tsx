...
describe("CustomFieldsPreview - Rendering Tests", () => {
  ...
  it("renders nothing when no field values provided", () => {
    const { container } = renderWithQuery(
      <CustomFieldsPreview fieldValues={[]} videoId="video-123" />
    );
  ...
  it("renders nothing when all fields have show_on_card=false", () => {
    ...
    const { container } = renderWithQuery(
      <CustomFieldsPreview fieldValues={fieldValues} videoId="video-123" />
    );
...
describe("CustomFieldsPreview - Edge Cases", () => {
  ...
  it("handles null values gracefully", () => {
    ...
    renderWithQuery(
      <CustomFieldsPreview
        ...
        videoId="video-123" // Only render 3
      />
    );
  ...
  it("handles very long field names", () => {
    const longName =
      "This Is A Very Long Field Name That Should Still Render Correctly";
    const fieldValues = [
      {
        ...createRatingField(),
        field_name: longName,
