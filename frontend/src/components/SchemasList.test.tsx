...
describe("SchemasList", () => {
  ...
  it("renders all schemas as cards", () => {
    render(<SchemasList listId="list-1" schemas={mockSchemas} />, {
  ...
  it("renders schemas in grid layout", () => {
    const { container } = render(
      <SchemasList listId="list-1" schemas={mockSchemas} />,
      { wrapper: createWrapper() }
    );
  ...
  it("renders empty list gracefully", () => {
    const { container } = render(<SchemasList listId="list-1" schemas={[]} />, {
      wrapper: createWrapper(),
    });
