...
describe('CategorySelector', () => {
  ...
  describe('Clear Button (Step 5.2)', () => {
    it('shows clear button when category is selected', () => {
      ...
      expect(screen.getByRole('button', { name: /kategorie entfernen/i })).toBeInTheDocument()
    })
    ...
    it('does not show clear button when no category is selected', () => {
      ...
      expect(screen.queryByRole('button', { name: /kategorie entfernen/i })).not.toBeInTheDocument()
    })
    ...
    it('shows warning dialog when clear button is clicked (onCategoryChange called after confirm)', async () => {
      ...
      const clearButton = screen.getByRole('button', { name: /kategorie entfernen/i })
      ...
      const confirmButton = screen.getByRole('button', { name: /kategorie entfernen/i })
