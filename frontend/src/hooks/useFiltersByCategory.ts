...
export function useFiltersByCategory(
  ...
  const schema1 = useSchema(listId, selectedCategories[0]?.schema_id || undefined)
  const schema2 = useSchema(listId, selectedCategories[1]?.schema_id || undefined)
  const schema3 = useSchema(listId, selectedCategories[2]?.schema_id || undefined)
  const schema4 = useSchema(listId, selectedCategories[3]?.schema_id || undefined)
  const schema5 = useSchema(listId, selectedCategories[4]?.schema_id || undefined)
