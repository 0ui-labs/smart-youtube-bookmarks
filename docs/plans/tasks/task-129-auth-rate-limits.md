# Task #129: Apply rate limits to auth endpoints (5/min production)

**Plan Task:** #129
**Wave/Phase:** Security Hardening - Task 4: API Rate Limiting (Step 4)
**Dependencies:** Task #125 (Rate limiting utilities), Task #110 (JWT auth endpoints)
...
**Not required** - Rate limiting utilities are already tested in Task #125 (`tests/core/test_rate_limit.py`)
...
**Related Task Plans:**
- `docs/plans/tasks/task-125-implement-rate-limiting-utilities.md` - Rate limiting infrastructure
- `docs/plans/tasks/task-110-jwt-auth-endpoints.md` - Auth endpoint implementation
- `docs/plans/tasks/task-124-add-slowapi-dependency.md` - slowapi installation
...
**Pattern to follow:**
- `backend/app/core/rate_limit.py` - Rate limiting utilities (Task #125)
- `backend/app/main.py` - Rate limiter integration (Task #125)

**Files to modify:**
- `backend/app/api/auth.py` - Login and register endpoints (Task #110)
...
- **Future enhancement:** Task #125 implements user-based limiting for authenticated API endpoints
...
- Task #124: Add slowapi dependency - COMPLETE
- Task #125: Implement rate limiting utilities - COMPLETE
- Task #110: JWT auth endpoints - COMPLETE

**Follow-up tasks:**
- Task #113: Protect API endpoints (will use `API_RATE_LIMIT` constant)
- Task #128: Apply rate limits to API endpoints (100/min production)
