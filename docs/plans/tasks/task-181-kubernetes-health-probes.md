# Task #181: Add Kubernetes Liveness/Readiness Probes

**Plan Task:** #181
**Wave/Phase:** Security Hardening P2 - Operational Excellence (Task 8: Comprehensive Health Checks)
**Dependencies:** Task #179 (Database Health Check), Task #180 (Redis Health Check)
...
**Application:**
- Use async health checks with reasonable timeouts (already implemented in Tasks #179-142)
...
async def readiness_check() -> Dict[str, Any]:
    ...
    **Why Check Dependencies:**
    ...
    """
    # Check all dependencies (implemented in Tasks #179-142)
...
- Ensures check_database() and check_redis() implementations (from Tasks #179-142) integrate correctly
...
**Dependencies:**
- Task #179: `check_database()` implementation (database health check)
- Task #180: `check_redis()` implementation (Redis health check)

**Related Code:**
- `backend/app/api/health.py` - Health check router (implemented in Tasks #179-142, extended in this task)
...
**Decision 4: Use Async Helper Functions from Tasks #179-142**

**Rationale:**
- `check_database()` already implemented in Task #179 (database connectivity check)
- `check_redis()` already implemented in Task #180 (Redis PING check)
...
**Evidence:** Existing implementations verified in Tasks #179-142
...
**Next Tasks:**
- Task #182: Implement structured logging with structlog (Security Hardening P2)
