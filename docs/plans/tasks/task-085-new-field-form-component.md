# Task #85: Create NewFieldForm Component with Type Selector and Config Editor
...
- [ ] Integration with FieldConfigEditor sub-components (Task #86) for type-specific config
- [ ] Integration with DuplicateWarning component (Task #87) for duplicate alerts
 ...
 * Used within SchemaEditor component (Task #83).
 * 
 * Features:
 ...
 * - Integration with FieldConfigEditor sub-components (Task #86)
 * - Integration with DuplicateWarning component (Task #87)
...
// TODO: Import from Task #86 when available
// import { FieldConfigEditor } from './FieldConfigEditor'
// TODO: Import from Task #87 when available
    ...
    <Form {...form}>
      <form onSubmit={handleSubmit} className="space-y-4 border rounded-lg p-4 bg-muted/50">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              {/* TODO: Replace with DuplicateWarning component (Task #87) */}
        ...
        <div className="space-y-2">
          ...
          {/* TODO: Replace with FieldConfigEditor component (Task #86) */}
          {/* Placeholder config editors */}
          {selectedType === 'select' && (
            <div className="space-y-2 border rounded-md p-3 bg-background">
              <p className="text-sm text-muted-foreground">
                Select field configuration (Task #86 pending)
              </p>
...
### Step 6: Create Integration with Task #86 (FieldConfigEditor Placeholder)

**Files:** `frontend/src/components/fields/FieldConfigEditor.tsx` (NEW - Placeholder for Task #86)

**Action:** Create placeholder component to unblock Task #85

```typescript
/**
 * FieldConfigEditor Component (Placeholder for Task #86)
 * 
 * This is a placeholder implementation to unblock Task #85.
 * The full implementation will be done in Task #86.
 * 
 * TODO Task #86: Implement type-specific config editors:
...
export const FieldConfigEditor = ({
  ...
  return (
    <div className="border rounded-md p-3 bg-muted/50">
      <p className="text-sm text-muted-foreground">
        FieldConfigEditor for type "{fieldType}" (Task #86 pending)
      </p>
...
### Step 7: Create Integration with Task #87 (DuplicateWarning Placeholder)

**Files:** `frontend/src/components/fields/DuplicateWarning.tsx` (NEW - Placeholder for Task #87)

**Action:** Create placeholder component to unblock Task #85

```typescript
/**
 * DuplicateWarning Component (Placeholder for Task #87)
 * 
 * This is a placeholder implementation to unblock Task #85.
 * The full implementation will be done in Task #87.
 * 
 * TODO Task #87: Implement reusable duplicate warning with:
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-yellow-700 mt-1">
        DuplicateWarning full implementation pending (Task #87)
      </p>
    </div>
  )
}
...
- Features:
  ...
  - Type selector (select, rating, text, boolean)
  - Dynamic config editor based on selected type
  - Integration with FieldConfigEditor (Task #86) and DuplicateWarning (Task #87)
...
### Integration Tests (Deferred to Task #83)

Integration testing will be done in SchemaEditor component (Task #83) where NewFieldForm is used in real context with field list management and schema creation flow.

**Scenarios for Task #83:**
...
- **Task #86:** FieldConfigEditor sub-components (TODO placeholders in this task)
- **Task #87:** DuplicateWarning component (TODO placeholder in this task)
- **Task #83:** SchemaEditor component (will consume NewFieldForm)
...
### 4. Placeholder Components for Task #86 and #87

**Decision:** Create placeholder FieldConfigEditor and DuplicateWarning components

**Rationale:**
- **Parallel Development:** Unblocks Task #85 while Task #86/87 in progress
...
- Visual placeholder (border, muted background, "Task #86 pending" text)
- TODO comments with feature requirements
- Basic functionality for NewFieldForm integration

**Next Steps:** Replace placeholders in Task #86 and #87 execution
...
│       ├── FieldConfigEditor.tsx       # Placeholder (Step 6, full in Task #86)
│       └── DuplicateWarning.tsx        # Placeholder (Step 7, full in Task #87)
├── types/
...
**With Task #86 (FieldConfigEditor):**
...
| FieldConfigEditor integration | Step 6 placeholder (TODO for Task #86) | ⏳ Placeholder |
| DuplicateWarning integration | Step 7 placeholder (TODO for Task #87) | ⏳ Placeholder |
...
## 🚀 Next Steps After Task #85

1. **Task #86:** Implement FieldConfigEditor sub-components
...
2. **Task #87:** Implement DuplicateWarning component
...
3. **Task #83:** Implement SchemaEditor component
