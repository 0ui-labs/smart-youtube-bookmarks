# Task #183: Add youtube_id length and format checks

**Plan Task:** #183
**Wave/Phase:** Security Hardening - Database Constraints
**Dependencies:** Task #182 (Database Constraints Skeleton), Task #181 (Kubernetes Health Probes)
...
**LENGTH Function:**
- Function: `LENGTH(text) → integer`
- Returns: Number of characters in string
- Example: `LENGTH('dQw4w9WgXcQ') = 11` → TRUE
- Works with: TEXT, VARCHAR, any text type

**Regex Operator (~):**
- Syntax: `text ~ pattern`
- Pattern: POSIX Extended Regular Expressions
- Example: `'dQw4w9WgXcQ' ~ '^[a-zA-Z0-9_-]{11}$'` → TRUE
