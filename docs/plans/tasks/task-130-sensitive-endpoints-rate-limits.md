# Task #130: Apply rate limits to sensitive endpoints (100/min production)

**Plan Task:** #130
**Wave/Phase:** Security Hardening - Task 4
**Dependencies:** Task #125 (rate limiting utilities must be implemented first)
...
```bash
# Run rate limit utility tests (Task #125)
cd backend
...
**Related Code:**
- Rate limiting utilities: `/Users/philippbriese/Documents/dev/projects/by IDE/Claude Code/Smart Youtube Bookmarks/backend/app/core/rate_limit.py` (Task #125)
- Rate limit tests: `/Users/philippbriese/Documents/dev/projects/by IDE/Claude Code/Smart Youtube Bookmarks/backend/tests/core/test_rate_limit.py` (Task #125)
