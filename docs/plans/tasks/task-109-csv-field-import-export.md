# Task #109: CSV Import/Export for Custom Field Values
...
Task #109 (Custom Fields System Phase 3)
...
- Future: Add progress bar for large imports (Task #110+)
...
- Task #110+ (Future): CSV import progress tracking
