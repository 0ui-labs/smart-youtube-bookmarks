# Task #121: Create SchemaEditor Component for Inline Schema Creation

**Status:** Planning
**Estimated Effort:** 10-14 hours (RECOMMEND SPLITTING INTO SUB-TASKS)
**Dependencies:** 
- Task #117 (useCustomFields hook) - PENDING, can be mocked
- Task #118 (useSchemas hook) - PENDING, can be mocked
- Task #120 (TagEditDialog extension) - parallel implementation
...
**RECOMMENDATION:** Split into 5 sub-tasks (#121a-#121e) for manageable implementation.

### Sub-Component Breakdown

```
SchemaEditor (Task #121a - Main Shell)
├── SchemaMetadataFields (inline in SchemaEditor)
│   ├── Schema Name (required)
│   └── Description (optional)
├── FieldSelector (Task #121b - 3-4 hours)
│   └── Combobox multi-select from existing fields
├── NewFieldForm (Task #121c - 4-5 hours)
...
**Create Mock Hooks (until Tasks #117, #118 complete):**
...
### Task #121a: SchemaEditor Main Shell (2 hours)
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            {/* FieldSelector Button (Task #121b) */}
          </div>
        </div>

        {/* NewFieldForm (Task #121c) */}
        {isCreatingField && (
...
### Task #121b: FieldSelector Component (3-4 hours)
...
### Task #121c: NewFieldForm Component (4-5 hours)
...
### Task #121d: FieldOrderManager Component (3-4 hours)
...
### Task #121e: Form Validation & Integration (2 hours)

**Goal:** Final validation, error handling, and integration into TagEditDialog.

**Files:**
- Update `frontend/src/components/CreateTagDialog.tsx` (extend for Task #120)
...
|------|-------------|----------------|
| **Task #121a** | SchemaEditor main shell + form state | 2 hours |
| **Task #121b** | FieldSelector combobox multi-select | 3-4 hours |
| **Task #121c** | NewFieldForm with duplicate check + FieldConfigEditor | 4-5 hours |
| **Task #121d** | FieldOrderManager with drag-drop | 3-4 hours |
| **Task #121e** | Validation + integration tests | 2 hours |
| **Total** | **14-17 hours** |
...
- Mock hooks allow parallel development with Tasks #117, #118
...
**Timeline:**
1. Day 1: Task #121a (2h) + Task #121b (4h) = 6 hours
2. Day 2: Task #121c (5h) + Task #121d start (2h) = 7 hours
3. Day 3: Task #121d finish (2h) + Task #121e (2h) = 4 hours

### Option 2: Split into Sub-Tasks (Recommended)

**Create separate task tickets:**
- Task #121a: SchemaEditor Shell (2h) - Priority: P0
- Task #121b: FieldSelector (4h) - Priority: P1
- Task #121c: NewFieldForm (5h) - Priority: P1
- Task #121d: FieldOrderManager (4h) - Priority: P2
- Task #121e: Integration (2h) - Priority: P3

**Benefits:**
- Parallel development possible (Task #121b + #121c)
...
## 🔄 Integration with Task #120 (TagEditDialog Extension)

Task #120 will extend CreateTagDialog with SchemaEditor. Integration points:

**TagEditDialog Changes:**
```typescript
// In CreateTagDialog.tsx (Task #120)
