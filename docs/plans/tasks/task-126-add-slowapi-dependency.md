# Task #126: Add slowapi Dependency
...
**Chosen:** Install in separate task (Task #126) before implementation (Task #127)
...
- Next task (Task #127) configures limiter with `storage_uri=settings.redis_url`
...
**NOT in scope:**
- Writing rate limiting code (Task #127)
- Integrating with FastAPI app (Task #127)
...
**Enables:**
- Task #127: Implement rate limiting utilities (uses slowapi library)
...
- **Task #127:** Create `app/core/rate_limit.py` with limiter instance
- **Task #127:** Integrate limiter into `app/main.py`
...
- Next task (Task #127) will have comprehensive tests
...
- [ ] Ready for Task #127 (implementation)
