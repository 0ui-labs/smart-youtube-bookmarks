# Task #147: Add NOT NULL Checks for Names

**Plan Task:** #147
**Wave/Phase:** Security Hardening (Task 9, Step 2)
**Dependencies:** Task #145-146 (other constraint migrations), User system (Task #110-119)
...
- `docs/plans/tasks/task-145-video-constraints.md` - Video constraint migration
- `docs/plans/tasks/task-146-unique-user-youtube.md` - User/YouTube unique constraint
