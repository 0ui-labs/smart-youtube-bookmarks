# Task #161: Create .env.development and .env.production.example
...
After Task #156 (Config Secret Validation) is implemented, these tests should be added to `backend/tests/core/test_config.py`:
...
- **Task #154**: Secret Generation Script (uses these .env templates)
- **Task #155**: Docker Compose Environment Variables (references these files)
- **Task #156**: Config Secret Validation (validates these configurations)
- **Task #157**: Secrets Setup Documentation (links to these guides)
- **Task #158**: Environment Enum Settings (extends ENVIRONMENT variable)
