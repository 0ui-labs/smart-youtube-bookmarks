# Task #184: Add UNIQUE Constraint for (user_id, youtube_id)

**Plan Task:** #184  
**Wave/Phase:** Phase 1 Security Hardening  
**Dependencies:** Task #183 (youtube_id length check), Task #1 (User model implementation)
...
Constraint name: videos_user_youtube_unique
Related to: Task #184 (Database Constraints, Step 2)
...
**Related Tasks:**
- Task #183: youtube_id length CHECK constraint (runs in same migration)
