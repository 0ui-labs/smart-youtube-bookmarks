# Task #84: Create FieldSelector Component (Multi-Select from Existing Fields)

**Plan Task:** #84
**Wave/Phase:** Custom Fields System - Phase 1 MVP - Frontend
**Dependencies:** Task #79 (useCustomFields hook) - can be mocked for parallel development
**Related Tasks:** Task #83 (SchemaEditor component uses FieldSelector as sub-component)

---

## 🎯 Ziel

Create a reusable FieldSelector component that enables multi-selecting existing custom fields from a searchable dropdown. This component will be used in the SchemaEditor (Task #83) to add pre-existing fields to a schema without creating duplicates.
...
### Step 4: Create Mock Hook (until Task #79 complete)
 ...
 * Replace with real hook from Task #79 when available
 */
...
### Step 6: Integration with SchemaEditor (Task #83)
...
**Not in this task, but documented for Task #83:**
...
**Task #83 Plan:**
- Lines 486-607: FieldSelector implementation (this plan is based on Task #83)
...
- Mock hook allows parallel development with Task #79
...
- [ ] Mock useCustomFields hook created (if Task #79 not done)
...
- [ ] Integration with SchemaEditor working (if Task #83 ready)
...
**Dependencies:**
- Task #79 (useCustomFields hook) - PARALLEL DEVELOPMENT: Use mock hook until ready
- Task #78 (TypeScript types) - FALLBACK: Use minimal types in plan if not ready

**Integration:**
- Task #83 (SchemaEditor) will import and use FieldSelector
- Task #85 (NewFieldForm) may reference FieldSelector pattern
