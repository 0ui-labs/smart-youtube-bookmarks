# Task #149: Create Security Utilities (Password Hashing, JWT)
...
git commit -m "feat: add password hashing and JWT token utilities (Task #149)
...
- Task plan: docs/plans/tasks/task-149-jwt-security-utilities.md
...
- **Dependency Injection:** Will be used in Task #150 for route protection
...
2. **Token Expiration:** 15 minutes default, configurable
   ...
   - **Future:** Refresh tokens for longer sessions (Task #151)
...
- Will use `get_password_hash()` in registration endpoint (Task #150)
- Will use `verify_password()` in login endpoint (Task #150)
...
**Task #150:** Authentication Endpoints
...
**Task #151:** Refresh Token System
- Long-lived refresh tokens (7 days)
- Refresh token rotation
- Token revocation via Redis

**Task #152:** Rate Limiting
- slowapi integration
...
- [x] Ready for integration in Task #150 (auth endpoints)
