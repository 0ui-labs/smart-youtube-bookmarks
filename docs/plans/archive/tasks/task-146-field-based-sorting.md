# Task #146: Implement Field-Based Sorting
...
**Note:** This step is OPTIONAL for Task #146. Focus on sorting existing columns first. Field columns can be added in Task #147 (extend VideosPage to show field values).
...
4. **Multi-Column Sorting: Deferred to Future Task**
   - ❌ Not implemented in Task #146 (secondary sort with Shift+Click)
...
- Dynamic field columns (Step 6) are OPTIONAL - can be deferred to Task #147
