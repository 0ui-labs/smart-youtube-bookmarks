# Task #137: Add Schema Actions (Edit, Delete, Duplicate, Usage Stats) - Implementation Plan

**Created:** 2025-11-08
**Status:** Planning Complete - Ready for Execution
**Phase:** Phase 2 - Settings & Management UI (Custom Fields System)
**Dependencies:** Task #136 (SchemasList component), Task #68 (Field Schemas CRUD endpoints)
...
This plan provides complete implementation details for adding action menu functionality to SchemaCard components. The implementation extends the SchemaCard from Task #136 with a three-dot dropdown menu offering four actions: Edit, Delete, Duplicate, and Usage Statistics.
...
- Alternative: Add backend endpoint in future (Task #138+)
...
│ └─────────────────────────────────────────────┘ │
│                                                  │
│ Body (3 fields preview from Task #136)           │
└──────────────────────────────────────────────────┘
...
```typescript
// frontend/src/components/SchemaCard.tsx (extend from Task #136)
...
**File:** `frontend/src/types/schema.ts` (may already exist from Task #118)
...
**Toast Notifications (Future Enhancement - Task #138+):**
...
1. **No Toast Notifications**:
   ...
   - **Future:** Install `sonner` toast library (Task #138+)
...
- Task #136 Plan: `/task-136-full-plan.md`
