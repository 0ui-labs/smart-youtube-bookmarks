...
class TestBatchUpdateVideoFieldValues:
    ...
    @pytest.fixture
    async def test_list_for_fields(self, test_db: AsyncSession, test_user) -> 'BookmarkList':
    ...
    @pytest.fixture
    async def test_video_for_fields(self, test_db: AsyncSession, test_list_for_fields) -> Video:
    ...
    @pytest.fixture
    async def test_fields(self, test_db: AsyncSession, test_list_for_fields) -> dict[str, CustomField]:
    ...
    @pytest.mark.asyncio
    async def test_error_invalid_field_id(self, client: AsyncClient, test_video_for_fields: Video):
    ...
    @pytest.mark.asyncio
    async def test_batch_size_limit(self, client: AsyncClient, test_video_for_fields: Video):
    ...
    @pytest.mark.asyncio
    async def test_empty_request_rejected(self, client: AsyncClient, test_video_for_fields: Video):
