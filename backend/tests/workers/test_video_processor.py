...
@pytest.mark.asyncio
@patch('app.workers.video_processor.YouTubeClient')
async def test_process_video_creates_channel(mock_youtube_client, arq_context, test_db, test_user):
...
@pytest.mark.asyncio
@patch('app.workers.video_processor.YouTubeClient')
async def test_process_video_reuses_existing_channel(mock_youtube_client, arq_context, test_db, test_user):
